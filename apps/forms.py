...
class EndpointForm(forms.Form):
    ...
    plaats = forms.BooleanField(required=False)
    plaatsfilter = forms.CharField(required=False)
    datum = forms.BooleanField(required=False)
    datumfilter = forms.CharField(required=False)
    techniek = forms.BooleanField(required=False)
    techniekfilter = forms.CharField(required=False)
    materiaal = forms.BooleanField(required=False)
    materiaalfilter = forms.CharField(required=False)
